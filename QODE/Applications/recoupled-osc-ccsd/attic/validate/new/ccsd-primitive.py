...
if __name__ == "__main__":
	...
	for n_mol,max_states in [ [2,10],[5,10],[10,9],[20,5] ]:
		...
		if analytical_value is None:  out.log("+++++++++++++++++++++ %d ho %d mol           ++++++++++++++++++++++++++++++++++++++\nFAILED!!" %(n_ho, n_mol))
			...
			n_state = 3
			while n_state <= max_states and main(mol_obj, [n_state for i in range(n_mol*n_ho)], out, analytical_value, resources):
				#n_state += 1
				n_state += (max_states - 3)
