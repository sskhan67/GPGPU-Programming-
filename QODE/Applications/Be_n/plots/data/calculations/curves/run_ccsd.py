...
# Usage:  python3 run.py <n_atoms> <separation> <path>
n_atoms     = sys.argv[1]
...
E_e = excitonic.ccsd(H, out, resources)

out.log("\nTotal Excitonic CCSD Energy = ", E_n + E_e)
out.log.write("ccsd_Be{}_{}_path={}.log".format(n_atoms, separation, path.replace("/",":")))
