...
long long total_index_to_valence_index(long long index, long long num_spat_orbs, long long num_core_spat_orbs)
{
    if (index < num_spat_orbs) {return index - num_core_spat_orbs;}
    else                       {return index - num_core_spat_orbs*2;}
}

long long find_1e_state_index( long long  num_valence_elec , long long num_valence_orbs,   long long  num_spat_orbs, long long num_core_spat_orbs, \
                               long long* ref_val_state, long long* combo_matrix, long long  orig,          long long excited )
{
    long long sorted_val_state[num_valence_elec];
    long long index = -1;
    long long temp;
    for (long long i=0; i<num_valence_elec; i++)
    {
...
long long find_2e_state_index( long long  num_valence_elec , long long num_valence_orbs,   long long  num_spat_orbs, long long num_core_spat_orbs, \
                               long long* ref_val_state, long long* combo_matrix, long long  orig1,         long long orig2,       \
...
int is_core_elec(long long orb, long long num_core_spat_orbs, long long* alpha_core_elec, long long* beta_core_elec)
{
    for (long long i=0; i<num_core_spat_orbs; i++)
    {
                  ...
                  int nthd)
{
    ...
    long long num_valence_elec = num_elec      - num_core_elec;
    long long num_valence_orbs = num_spin_orbs - num_core_elec;
    long long num_spat_orbs      = num_spin_orbs / 2;
    long long num_core_spat_orbs = num_core_elec / 2;

    long long alpha_core_elec[num_core_spat_orbs], beta_core_elec[num_core_spat_orbs];
    for (long long i=0; i<num_core_spat_orbs; i++)
    {
        alpha_core_elec[i] = i;
    ...
    for (long long n=0; n<num_fci_configs; n++)
    {
        ...
        if (any_significant_C)
        {
            ...
            long long* ket_val_state = &C_FciValConfigs[n*num_valence_elec];
            long long  sorted_state[num_elec];
            long long  valence_state[num_valence_elec];
            ...
            long long* linear_list = (long long*) malloc( sizeof(long long) * 4 * num_spin_orbs * num_elec ); // 4 entries in each list element
            long long list_index = 0, max_index;
            for(long long i=0; i<num_elec; i++)
            {
                orig1       = ket_state[i];
            ...
            for(long long loop_index=0; loop_index<max_index; loop_index++)
            {
                long long i = linear_list[loop_index*4];
                orig1       = linear_list[loop_index*4+1];
                gd1_is_core = linear_list[loop_index*4+2];
                long long j = linear_list[loop_index*4+3];
            ...
            linear_list = (long long*) malloc( sizeof(long long) * 7 * num_pairs * num_elec * num_elec ); // 4 entries in each list element
            list_index  = 0;
            ...
            for (long long loop_index=0; loop_index<max_index; loop_index++)
            {
                ...
                long long i = linear_list[loop_index*7];
                long long j = linear_list[loop_index*7+3];
