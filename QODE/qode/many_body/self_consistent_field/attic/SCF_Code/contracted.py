...
from math import pi
from qode.SCF_Code.matrix_loop import mat_loop,rep_loop
from qode.SCF_Code.matrix_operation import mat_add,mat_multiply,build_mat,build_mat_rep,printline,build_size_mat
from qode.SCF_Code import primitive
...
def cont_main(input_list,ngaussians,nulist,num_e,A_num_list):
    ...
    print("Original   T  dimensino =", len(T))
    print("Contracted T  dimensino =", len(T_c))

    print("Original   N  dimensino =", len(N))
    print("Contracted N  dimensino =", len(N_c))
    
    print("Original   V  dimensino =", len(V))
    print("Contracted V  dimensino =", len(V_c))
