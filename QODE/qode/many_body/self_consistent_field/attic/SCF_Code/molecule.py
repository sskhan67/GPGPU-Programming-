    ...
    try:
        ...
        while read:
            ...
            if len(line) == 0: # SO NO BLANK LINE ALLOWED IN BASIS FILES!!
                ...
                # If the atom is found, Stop reading, start new section.
                if basis_tmp[1]=='0':
        ...
        while read:
            ...
            if read_basis_tmp[0]=='****':
                ...
                if read_basis_tmp[2]=='1.00':
                    ...
                    # There are three p-orbitals so the return_list is tripled.
                ...
                if read_basis_tmp[2]=='1.00':
                    ...
                    # There is ONE s-orbital plus THREE p-orbitals
...
def make_atomic_number_list(inputatoms):
    ...
    atomtable = read_lines('/home/yhliu/Qode-clone/qode/SCF_Code/num_electron.in')
    num_e = []
...
def mol_main(name):
    ...
    return input_list,no_gauss,orbitype,atoms,num_electron,mul,A_num_list,correlation
